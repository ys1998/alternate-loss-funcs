...
class list_int(_object):
    ...
    def iterator(self):
        return _trie.list_int_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _trie.list_int___nonzero__(self)

    def __bool__(self):
        return _trie.list_int___bool__(self)

    def __len__(self):
        return _trie.list_int___len__(self)

    def __getslice__(self, i, j):
        return _trie.list_int___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _trie.list_int___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _trie.list_int___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _trie.list_int___delitem__(self, *args)

    def __getitem__(self, *args):
        return _trie.list_int___getitem__(self, *args)

    def __setitem__(self, *args):
        return _trie.list_int___setitem__(self, *args)

    def pop(self):
        return _trie.list_int_pop(self)

    def append(self, x):
        return _trie.list_int_append(self, x)

    def empty(self):
        return _trie.list_int_empty(self)

    def size(self):
        return _trie.list_int_size(self)

    def swap(self, v):
        return _trie.list_int_swap(self, v)

    def begin(self):
        return _trie.list_int_begin(self)

    def end(self):
        return _trie.list_int_end(self)

    def rbegin(self):
        return _trie.list_int_rbegin(self)

    def rend(self):
        return _trie.list_int_rend(self)

    def clear(self):
        return _trie.list_int_clear(self)

    def get_allocator(self):
        return _trie.list_int_get_allocator(self)

    def pop_back(self):
        return _trie.list_int_pop_back(self)

    def erase(self, *args):
        return _trie.list_int_erase(self, *args)
    ...
    def push_back(self, x):
        return _trie.list_int_push_back(self, x)

    def front(self):
        return _trie.list_int_front(self)

    def back(self):
        return _trie.list_int_back(self)

    def assign(self, n, x):
        return _trie.list_int_assign(self, n, x)

    def resize(self, *args):
        return _trie.list_int_resize(self, *args)

    def insert(self, *args):
        return _trie.list_int_insert(self, *args)

    def pop_front(self):
        return _trie.list_int_pop_front(self)

    def push_front(self, x):
        return _trie.list_int_push_front(self, x)

    def reverse(self):
        return _trie.list_int_reverse(self)
